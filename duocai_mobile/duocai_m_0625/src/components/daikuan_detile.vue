  ...
  <div class="box">
    ...
    <div class="box_1">
      ...
      <p class="p1">
        ...
        <span style="margin-left:1.5rem">借款期限：</span>
        <span>{{list.ew}}</span>
      </p>
    ...
    <div class="text">
      ...
      <h2 class="fl">基本信息</h2>
      <div class="clear"></div>
      <p v-html="list.content" style="margin: 0.2rem 0"></p>
      <!-- <p>申请条件，申请条件申请条件申请条件申请条件</p> -->
    </div>
    <!-- 相关推荐 -->
    <div class="tuijian" style="border-top:0.07rem solid #e6e6e6;padding-top: 0.3rem;">
      <div class="border fl"></div>
      <h2 class="fl">相关推荐</h2>
      <div class="clear"></div>
