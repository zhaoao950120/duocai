            ...
            <div class="list-main">
              ...
              <ul class="main">
                <li class="group" id="group1">
                  <p class="list" style="display: block;margin-top:0">
                    <a
                      class="cs-item"
                      target="_blank"
                      href="http://wpa.qq.com/msgrd?v=3&uin=3612327627&site=qq&menu=yes"
                    >
                ...
                <li style="text-align:center">
                  <p>扫码加微信</p>
                  <img src="../../assets/image/kefu2.jpg" alt style="width:150px;height:150px">
                  <p>wxid_xdn7e6sqrzml22</p>
                </li>
              </ul>
            </div>
          </div>
        ...
        <li v-for="(item,index) in list" :key="index">
          ...
          <div class="middle">
            ...
            <p style="   margin-top: 10px;">
              服务优势：
              <span
                v-for="(item1,index) in item.ys.slice(0,1)"
                :key="index"
                style="margin: 0 5px; margin-top: 3px;"
              >{{item1}}</span>
            </p>
          </div>
          <div class="bottom">
